    ...
    <body>
        <div class="GlobalContainer" id="GlobalContainer">
            ...
            <div class="WrittenWork">
                ...
                <p class="homeText">Si vous êtes chef d'une alliance respectable et cherchez à vous joindre à la famille, n'hésitez pas à contacter la haute deirection de la Famille!  Il nous fera plaisir de vous accueillir si vos objectifs rejoignent ceux de ma famille!</p>
            </div>
        </div>
